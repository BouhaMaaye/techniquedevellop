...
/*
 * \brief Affiche graphiquement (fenêtre) la grille g
 * \param g grille
...
/*
 * \brief Compare deux grilles renvoie 1 si mêmes 0 sinon
 * \param gf grille first
 * \param gs grille second
 */

int memes_grilles(grille gf, grille gs);

/*
 * \brief Verifie si grille vide renvoie 0 si vide 1 sinon
 * \param g grille
 */
...
/*
 * \brief Verifie si colonnie oscillante et renvoie la période si oui -1 sinon
 * \param g grille
 */ 
